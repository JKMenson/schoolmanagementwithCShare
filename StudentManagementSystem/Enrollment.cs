    ...
    public partial class Enrollment : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Enter Course ID to search!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    MessageBox.Show("You have successfully enrolled into '" + txtCouseName.Text + "'", "Success", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
            catch (Exception ex)
            {
